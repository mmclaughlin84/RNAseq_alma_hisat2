...
for sample_name in ${sample_names[@]}
  do
    sbatch --time=02:00:00 --job-name=align --partition=compute --mail-type=END,FAIL --mail-user=mmclaughlin@icr.ac.uk --cpus-per-task=8 --mem-per-cpu=4000 --output=log6_align_${sample_name}.txt \
