...
for sample_name in ${sample_names[@]}; do
	sbatch --time=00:40:00 --job-name=trim --partition=compute --mail-type=END,FAIL --mail-user=mmclaughlin@icr.ac.uk --cpus-per-task=8 --mem-per-cpu=1000 --output=log4_trim_${sample_name}.txt \
